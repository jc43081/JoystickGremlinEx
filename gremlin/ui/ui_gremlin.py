...
class Ui_Gremlin(object):
    def setupUi(self, Gremlin):
        ...
        self.menuTools.addAction(self.actionScVjoyMapper)
    ...
    def retranslateUi(self, Gremlin):
        ...
        Gremlin.setWindowTitle(_translate("Gremlin", "Joystick Gremlin SC"))
        ...
        self.actionScVjoyMapper.setText(_translate("Gremlin", "SC vJoy Mapper"))
